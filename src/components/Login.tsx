...
const Login = () => {
  ...
  return (
    <div className="flex justify-center items-center h-[100vh]  w-full">
      {isSignIn ? (
        <div className="bg-black p-10 text-black shadow-xl">
        ...
        <form
          className=" shadow-2xl p-8 sm:p-10 bg-white rounded-3xl flex justify-center items-center flex-col text-black transition-all duration-1000 ease-in-out"
          ...
          <div>
            <div className="formField flex gap-2 sm:gap-4 items-center">
              ...
              <input
                ...
                name="email"
                placeholder="Email"
                className="px-4 py-3 text-lg outline-none focus:outline-none w-[250px] sm:w-[300px] bg-gray-200 rounded-3xl "
                value={email}
